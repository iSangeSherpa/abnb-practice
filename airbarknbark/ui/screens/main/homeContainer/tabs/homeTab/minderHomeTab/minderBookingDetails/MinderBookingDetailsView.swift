//
//  MinderBookingDetailsView.swift
//  airbarknbark
//
...
class MinderBookingDetailsView : BaseUIView{
...
//        HDivider(verticalMargin: 8),
    ...
    lazy var detailsContainer = stack(VSpacer(Dimension.SIZE_8),detailsTop,detailsBottom,VSpacer(Dimension.SIZE_8), spacing: Dimension.SIZE_22.cgFloat).withMargins(.horizontal(20)).apply { it in
    ...
    lazy var selectedPetsView = stack(
        ...
        hstack(TitleH3(label: "Selected Pet"),UIView()),
        VSpacer(Dimension.SIZE_22),
    ...
    lazy var extraNotesView = stack(
        VSpacer(Dimension.SIZE_22),
        hstack(TitleH3(label: "Extra Notes"),UIView()),
        VSpacer(Dimension.SIZE_22),
        extraNotesLabel,
        VSpacer(Dimension.SIZE_22)
    ).withMargins(.horizontal(20)).apply { it in
    ...
    let startClockInButton = PrimaryButton(label: "Start Minding")
    let cancelButton = PrimaryButton(label: "Cancel")
        .apply {
