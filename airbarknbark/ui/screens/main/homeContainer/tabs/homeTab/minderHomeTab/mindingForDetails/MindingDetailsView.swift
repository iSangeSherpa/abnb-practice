...
class MindingForDetailsView : BaseUIView{
...
//        HDivider(verticalMargin: 8),
    ...
    let bookedAddress = TitleH3(label: "$240").apply { it in
        it.numberOfLines = 0
    ...
    let clockOutButton = PrimaryButton(label: "Finish Minding")
